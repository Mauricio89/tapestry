 ...
 * @author Mauricio
 */
public class ActualizarCiudades {
    ...
    void onPrepare() {    
        ciudad = daociudad.buscarId(idciudad); 
    }
    
    void onActivate(Integer idciudad) {
        ciudad = daociudad.buscarId(idciudad);
    } 
    ...
    public ProvinciaEncoder getProvinciaEncoder() {
     ...
     Class<ListaCiudades> onSuccess() { 
         daociudad.actualizarCiudad(ciudad.getIdciudad(), provincia.getIdprovincia(),ciudad.getNciudad());       
