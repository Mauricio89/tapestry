 ...
 * @author Mauricio
 */
public class ActualizarCantones {
    ...
    void onPrepare() {    
        canton = daocanton.buscarId(idcanton); 
    }
    
    void onActivate(Integer idcanton) {
        canton = daocanton.buscarId(idcanton);
    }  
    ...
    public ProvinciaEncoder getProvinciaEncoder() {
     ...
     Class<ListaCantones> onSuccess() { 
         daocanton.actualizarCanton(canton.getIdcanton(),provincia.getIdprovincia(),canton.getNcanton()); 
